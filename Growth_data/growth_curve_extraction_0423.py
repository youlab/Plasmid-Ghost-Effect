...
sample = "20260423_colE1_Day20_burden"
...
for br in range(3):
    ...
    df_timeseries_od.to_excel(f"./processed_data/Day20/colE1+BioRep{br+1}_OD.xlsx", index=False)

# MG1655 (colE1 cured) at Day 20
for br in range(3):
    target_wells = []
    labels = []
    for colony in range(3):
