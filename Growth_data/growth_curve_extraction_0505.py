...
sample = "20260505_pSC101_Day20_burden"
...
for br in range(3):
    ...
    df_timeseries_od.to_excel(f"./processed_data/Day20/pSC101+BioRep{br+1}_OD.xlsx", index=False)

# MG1655 (pSC101 cured) at Day 20
for br in range(3):
    target_wells = []
    labels = []
    for colony in range(3):
