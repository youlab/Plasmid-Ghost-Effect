"""
single Keio strain plasmid dynamics, for Comm57, focus on the donor strains #3 and #4 (PCU1 and R6K)
------------------------------------------------
• Requires:  pandas, numpy, scipy
• Input:     LT23_KeioV3_indiv_plating.xlsx  (sheets “Day0”, “Day3”, …, “Day25”)
...
# ---------------------------------------------------------------------
excel_file = "./raw_data/LT23_KeioV3_indiv_plating.xlsx"
...
for l, plasmid in enumerate(Plasmids):
    ...
    np.save(f"./processed_data/KV3_{plasmid}_mean.npy",abundance)
    np.save(f"./processed_data/KV3_{plasmid}_se.npy", se)
